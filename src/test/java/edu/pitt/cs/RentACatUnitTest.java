...
public class RentACatUnitTest {
	...
	public void testListCatsNumCats0() {
		// TODO: Fill in
		String listedCats = r.listCats(); 
		assertEquals(listedCats, "");
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals(result, "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n");
	}
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse("Expected renameCat(2, 'Garfield') to return false when no cats exist", isRenamed);
	...
	public void testReturnFailureCatNumCats3() {
		...
		when(c2.getRented()).thenReturn(false);
        boolean isReturned = r.returnCat(2);
        assertFalse("Expected returnCat(2) to return false when the cat is already present", isReturned);
