...
public class RentACatIntegrationTest {
	...
	public void setUp() throws Exception {
		...
		// TODO: Fill in
		this.c1 = Cat.createInstance(InstanceType.IMPL, 1, "Jennyanydots");
		...
		// TODO: Fill in
		this.c2 = Cat.createInstance(InstanceType.IMPL, 2, "Old Deuteronomy");
		// 4. Create a Cat with ID 3 and name "Mistoffelees", assign to c3 using a call to Cat.createInstance(InstanceType, int, String).
		// TODO: Fill in
		this.c3 = Cat.createInstance(InstanceType.IMPL, 3, "Mistoffelees");
